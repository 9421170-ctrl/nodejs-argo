...
const PORT = process.env.SERVER_PORT || process.env.PORT || 28337;        // http服务订阅端口
const UUID = process.env.UUID || 'a01b1231-fb29-44a3-a86a-9cefd4c42bc7'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
